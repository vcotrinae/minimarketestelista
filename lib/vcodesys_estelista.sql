...
-- Tiempo de generación: 09-02-2026 a las 10:25:08
...
--
-- Base de datos: `vcodesys_estelista`
--
...
CREATE TABLE `clientes` (
  ...
  `cli_documento` int(11) DEFAULT NULL,
  ...
  `cli_compras` int(11) DEFAULT NULL,
...
(1, 'Usuario Administrado', 'admin', '$2a$07$asxx54ahjppf45sd87a5auXBm1Vr2M1NV5t/zNQtGHGpS5fFirrbG', 'Administrador', 'vistas/img/usuarios/admin/994.png', 1, '2026-01-28 20:22:26', '2026-01-29 01:22:26', NULL, NULL),
...
CREATE TABLE `ventas` (
  ...
  `ven_id_vendedor` int(11) DEFAULT NULL,
  `ven_productos` text DEFAULT NULL,
...
--
ALTER TABLE `proveedores`
  MODIFY `prove_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `ventas`
  MODIFY `ven_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
